...
### Modeling of _TRPM4_-Ribo relationship with generalized additive model (GAM), with focus on modeling optimization, interpretability, mapping for top-ranked explanatory power (TREP) cells, and identification of their biology. Introducing the CEP-IP framework that separates cell subpopulations into quadrants.
