...
| 2    | `Part_2_UMAP_Heatmap_Spearman-Kendall's-matrix.r`           | Visualizes TRPM4 and KLK4 expression in UMAP clusters for PCa and non-Ca samples. Calculates Spearman’s and Kendall’s correlation matrices and creates a heatmap to compare TRPM4 with other significant gene sets. |
