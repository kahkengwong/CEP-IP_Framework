...
### Modeling of _TRPM4_-Ribo relationship with generalized additive model (GAM), focusing on model optimization and interpretability. Introducing the CEP-IP framework that separates cell subpopulations into quadrants, each with distinct biology.
